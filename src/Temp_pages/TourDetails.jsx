...
const TourDetails = () => {
  ...
  // Add second review manually
  const updatedReviews = [
    ...reviews,
    {
      username: "Traveler Jane",
      comment: "A truly unforgettable experience!",
      rating: 5,
            ...
            <Col lg="8">
              <div className="tour__content">
                  ...
                  <div className="d-flex align-items-center gap-5">
                    <span className="tour__rating d-flex align-items-center gap-1">
                      ...
                      {totalRating === 0 ? (
                        ...
                        <span>({updatedReviews.length})</span>
                      )}
                    </span>
                ...
                <div className="tour__reviews mt-4">
                  <h4>Reviews ({updatedReviews.length} reviews)</h4>
                  ...
                  <ListGroup className="user__reviews">
                    {updatedReviews.map((review, index) => (
                      <div className="review__item" key={index}>
                        <img src={review.avatar || avatar} alt="user" />
                        ...
                        <div className="w-100">
                          ...
                          <h6>{review.comment || "Amazing Tour"}</h6>
                        </div>
                      </div>
                    ))}
                  </ListGroup>
